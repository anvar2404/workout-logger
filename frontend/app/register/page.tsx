    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="anim-up" style={{ width: '100%', maxWidth: 360 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ fontFamily: 'var(--font-dm)', fontSize: 13, color: 'var(--text-3)' }}>Start tracking your lifts</p>
        </div>

        <div className="card" style={{ padding: '28px 24px' }}>
          <h2 style={{ fontFamily: 'var(--font-dm)', fontWeight: 700, fontSize: 20, color: 'var(--text)', marginBottom: 20 }}>Create account</h2>

          <form onSubmit={submit}>
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontFamily: 'var(--font-dm)', fontSize: 12, fontWeight: 600, color: 'var(--text-2)', display: 'block', marginBottom: 6 }}>Name</label>
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" style={{ width: '100%', borderRadius: 10, padding: '11px 14px', fontSize: 14 }} />
            </div>
            <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min 6 characters" required minLength={6} style={{ width: '100%', borderRadius: 10, padding: '11px 14px', fontSize: 14 }} />
            </div>
